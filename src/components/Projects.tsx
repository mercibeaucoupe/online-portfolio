...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Collaborative project management tool with real-time updates, task tracking, team collaboration features, and comprehensive reporting capabilities.",
      image: project2,
    ...
    },
    {
      ...
      description: "Modern chat application with instant messaging, file sharing, group chats, and end-to-end encryption for secure communication.",
      image: project3,
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-12">
            {projects.map((project, index) => (
              ...
              >
                <div className={`grid ${project.featured ? 'lg:grid-cols-2' : 'md:grid-cols-2'} gap-0 h-full`}>
                  {/* Project Image */}
