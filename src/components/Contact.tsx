	...
	const contactInfo = [
		{
			...
			title: 'Email',
			value: 'jung_woo@live.com',
			link: 'mailto:jung_woo@live.com',
		},
		{
			icon: <Phone className="h-6 w-6" />,
			title: 'Phone',
			value: '+1 (770) 608-4373',
			link: 'tel:+17706084373',
		},
		{
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mb-16">
						...
						<p className="text-xl text-muted-foreground max-w-3xl mx-auto">
							Let's discuss your next project or explore opportunities to work together. I'm always
							excited to take on new challenges and create amazing solutions.
						</p>
					</div>
						...
						<div className="space-y-8">
							...
							<div className="space-y-6">
								{contactInfo.map((info, index) => (
									<Card
										key={index}
										className="p-6 bg-card/30 border-primary/20 hover:shadow-card transition-all duration-300 group"
									>
										<a
											href={info.link}
